        ...
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <div class="order-info">
                    <form action="sale-order-detail" method="post">
                        ...
                        <p><strong>Sale Name:</strong> ${order.getEmployee().getFullName()}</p>
                        ...
                        <p></p>
                        ${isEdit == '0' ? "" : '<button class="btn btn-primary btn-sm" onclick="this.form.submit()">Update</button>'}
