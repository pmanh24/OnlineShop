    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <div class="container content">
                <h1 class="text-center my-4">Slider Detail & Edit</h1>
                <div class="row">
                    <!-- Detail of Slider -->
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Detail of Slider</h5>
                            </div>
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <img src="${slider.imageUrl}" alt="${slider.title}" class="img-fluid">
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Status:</strong> ${slider.statusNum == 1 ? 'Active' : 'Inactive'}
                                    </li>
                                    <li class="list-group-item">
                                        <strong>BackLink</strong> ${slider.backLink}
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Note:</strong> ${slider.note}
                                    </li>
                                    <li class="list-group-item">
                                        <a href="${pageContext.request.contextPath}/mkt-slider-list" class="btn btn-secondary">Back to Slider List</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="sliderdetail" method="post" enctype="multipart/form-data">
                                    <!-- Hidden input for slider ID -->
                                    <input type="hidden" name="sliderId" value="${slider.sliderId}" >
                                    <!-- Title input -->
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputTitle">Title</label>
                                        <input class="form-control" id="inputTitle" type="text" name="title" value="${slider.title}"  placeholder="Enter Title" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputBackLink">BackLink</label>
                                        <input class="form-control" id="inputBackLink" type="text" value="${slider.backLink}" name="back_link">
                                    </div>

                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputnote">Note</label>
                                        <input class="form-control" id="inputnote" type="text" value="${slider.note}" name="note">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="inputStatus" name="status" required>
                                            <option value="1" ${slider.statusNum == 1 ? 'selected' : ''}>Active</option>
                                            <option value="0" ${slider.statusNum == 0 ? 'selected' : ''}>Inactive</option>
                                        </select>
                                    </div>
