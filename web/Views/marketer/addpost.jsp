    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <div class="container content d-flex justify-content-center">
                <div class="form-container" style="width: 82%; background-color: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <form action="${pageContext.request.contextPath}/addpost" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="detail" name="detail" rows="4" class="form-control" required></textarea>
                        </div>

                        <div class="form-group">
                            <label for="shortContent">Short Content:</label>
                            <input type="text" id="shortContent" name="shortContent" class="form-control" required>
                        </div>
                        ...
                        <a href="${pageContext.request.contextPath}/postlist" class="btn btn-secondary btn-block mt-3">Back to post list</a>
                        <h1>${message}</h1>
                    </form>
