                ...
                <div class="content">
                    ...
                    <c:choose>
                        <c:when test="${not empty param.showProduct}">
                            <div class="row">
                                <div class="col-12">
                                    <!-- Include the product list table -->
                                    <jsp:include page="product-list.jsp"></jsp:include> <!-- Adjusted path -->
                                    </div>
                                </div>
                        </c:when>
                        <c:when test="${not empty param.showSlider}">
                            <div class="row">
                                <div class="col-12">
                                    <!-- Include the product list table -->
                                    <jsp:include page="sliderList.jsp"></jsp:include> <!-- Adjusted path -->
                                    </div>
                                </div>
                        </c:when>
                        <c:when test="${not empty param.showBlog}">
                            <div class="row">
                                <div class="col-12">
                                    <!-- Include the product list table -->
                                    <jsp:include page="postlist.jsp"></jsp:include> <!-- Adjusted path -->
                                    </div>
                                </div>
                        </c:when>
