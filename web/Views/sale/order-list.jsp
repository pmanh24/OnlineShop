    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <div class="filters">
                    <form action="sale-order-list" method="get">
                        <div class="filter-row">
                            <label for="search" style="margin-right: 10px;margin-top: 10px">Search:</label>
                            <input type="text" placeholder="Search by Order ID" id="searchOrderId" name="orderId" value="${orderIdValue}" style="margin-left: 33px;">
                            <input type="text" placeholder="Search by Customer Name" id="searchCustomerName" name="customerName"value="${customerNameValue}">
                ...
                <table>
                    ...
                    <tbody id="orderList">
                        ...
                        <c:forEach items="${orderList}" var="s" varStatus="status">
                            <tr>
                                <td><a href="sale-manager-order-detail?orderId=${s.getOrderId()}">${s.getOrderId()}</a></td>
                                ...
                                <td>
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <form action="sale-order-list" method="post">
                ...
                <div class="pagination">
                    ...
                    <c:forEach begin="${1}" end ="${requestScope.numpage}" var="i">
                        <li class="page-btn"><a  href="sale-order-list?page=${i}&${path}">${i}</a></li>
                        </c:forEach>
