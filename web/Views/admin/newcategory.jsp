...
<html lang="en">
    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <div class="content">
                <form id="myForm" action="new-category" method="POST">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="category-list" class="btn btn-secondary">Back to list category</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script>
            function callAlert(event) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "New Category will be created!",
                    icon: "warning",
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            ...
                            Swal.fire({
                                title: "Creating...",
                                text: "Please wait while we create the new category.",
                                icon: "info",
