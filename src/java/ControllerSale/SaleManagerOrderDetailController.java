 ...
 * @author Admin
 */
@WebServlet(name = "SaleManagerOrderDetailController", urlPatterns = {"/sale-manager-order-detail"})
public class SaleManagerOrderDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SaleManagerOrderDetailController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SaleManagerOrderDetailController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<EmployeeCount> employee = dao.getAllSaleEmployees();
        ...
        request.getRequestDispatcher("Views/sale/sale-manager-order-detail.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (saleid != null) {
            dao.updateSaleEmployeeForOrder(Integer.parseInt(orderId), Integer.parseInt(saleid));
            request.setAttribute("message", "Order update successfully!");
        }
