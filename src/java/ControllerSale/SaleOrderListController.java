 ...
 * @author GIGABYTE
 */
@WebServlet(name = "OrderListController", urlPatterns = {"/sale-order-list"})
public class SaleOrderListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<StatusCount> statusList = dao.getAllStatusCount(2);
        String path = "";
        ...
        if (orderId != null && !orderId.isEmpty()) {
            if (!orderId.endsWith("null")) {
                System.out.println("vao order id ");
        ...
        if (customerName != null && !customerName.isEmpty()) {
            if (!customerName.endsWith("null")) {
                System.out.println("vao customer name");
        ...
        if (orderIdQuery == null && customerNameQuery == null && saleNameQuery == null && dateFromQuery == null && dateToQuery == null && statusQuery == null) {
            ...
            orders = dao.SearchAllOrderByKey(orderIdQuery, customerNameQuery, dateFromQuery, dateToQuery, statusQuery, saleNameQuery);
            path = "orderId=" + orderId + "&customerName=" + customerName + "&saleName=" + saleName + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&status=" + status;
        }
        ...
        request.getRequestDispatcher("Views/sale/order-list.jsp").forward(request, response);
    }
